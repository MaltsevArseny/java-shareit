...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    List<Booking> findCurrentBookingsByOwner(@Param("ownerId") Long ownerId, @Param("now") LocalDateTime now, Pageable pageable);
    ...
    List<Booking> findPastBookingsByOwner(@Param("ownerId") Long ownerId, @Param("now") LocalDateTime now, Pageable pageable);
    ...
    List<Booking> findFutureBookingsByOwner(@Param("ownerId") Long ownerId, @Param("now") LocalDateTime now, Pageable pageable);
}